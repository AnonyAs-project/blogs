              ...
              {notifications?.length > 0 ? (
                notifications.map((notification) => (
                  <div
                    ...
                    className={`relative p-4 border-b border-gray-600 rounded-lg transition-all ease-in-out duration-200 my-2 cursor-pointer ${
                      notification.read ? "bg-gray-600" : "bg-[#0000001a]"
                    }`}
